...
var _tonemasks = new Float32Array([
  /* 62.5 Hz */
...
var tonemasks = (function() {
  var a = calloc(P_BANDS, []);
  for (var i = 0; i < P_BANDS; i++) {
    a[i] = calloc(6, []);
    for (var j = 0; j < 6; j++) {
      a[i][j] = pointer(_tonemasks, (i+j)*EHMER_MAX, EHMER_MAX);
    }
  }
  return a;
})();
